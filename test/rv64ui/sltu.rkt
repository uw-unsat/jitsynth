...
;include "test_macros.h"
  ...
  (TEST_RR_OP 2  'sltu 0 #x00000000 #x00000000 );
  (TEST_RR_OP 3  'sltu 0 #x00000001 #x00000001 );
  (TEST_RR_OP 4  'sltu 1 #x00000003 #x00000007 );
  (TEST_RR_OP 5  'sltu 0 #x00000007 #x00000003 );

  (TEST_RR_OP 6  'sltu 1 #x00000000 #xffff8000 );
  (TEST_RR_OP 7  'sltu 0 #x80000000 #x00000000 );
  (TEST_RR_OP 8  'sltu 1 #x80000000 #xffff8000 );

  (TEST_RR_OP 9  'sltu 1 #x00000000 #x00007fff );
  (TEST_RR_OP 10 'sltu 0 #x7fffffff #x00000000 );
  (TEST_RR_OP 11 'sltu 0 #x7fffffff #x00007fff );

  (TEST_RR_OP 12 'sltu 0 #x80000000 #x00007fff );
  (TEST_RR_OP 13 'sltu 1 #x7fffffff #xffff8000 );

  (TEST_RR_OP 14 'sltu 1 #x00000000 #xffffffff );
  (TEST_RR_OP 15 'sltu 0 #xffffffff #x00000001 );
  (TEST_RR_OP 16 'sltu 0 #xffffffff #xffffffff );
